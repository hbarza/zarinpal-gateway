 ...
 * @author     Hassan Barza <support@codnitive.com>
 */
class Codnitive_ZarinpalGateway_Model_System_Config_Backend_Encryptedserial extends Mage_Core_Model_Config_Data
{
    ...
    protected function _beforeSave()
    {
        ...
        if (empty($value)) {
            Mage::throwException(Mage::helper('zarinpalgateway')->__('%s is required.', 
                    Mage::helper('zarinpalgateway')->__($fieldConf->label)));
        }
        ...
        if (!$validator->isValid($value)) {
            Mage::throwException(Mage::helper('zarinpalgateway')->__('%s is not valid.', 
                    Mage::helper('zarinpalgateway')->__($fieldConf->label)));
        }
        ...
        try {
            ...
            try {
                ...
                curl_setopt($ch, CURLOPT_URL, Mage::helper('zarinpalgateway')->getConUrl().'update/');
